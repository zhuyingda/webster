...
RUN adduser work
RUN wget https://nodejs.org/dist/v14.15.1/node-v14.15.1-linux-x64.tar.xz \
    -O /home/work/node-v14.15.1-linux-x64.tar.xz
RUN xz -d /home/work/node-v14.15.1-linux-x64.tar.xz
RUN tar -xvf /home/work/node-v14.15.1-linux-x64.tar -C /home/work/
RUN ln -s /home/work/node-v14.15.1-linux-x64/bin/node /usr/local/bin/node
RUN ln -s /home/work/node-v14.15.1-linux-x64/bin/npm /usr/local/bin/npm
RUN rm /home/work/node-v14.15.1-linux-x64.tar
USER work
